...
* 采用前后端分离的模式，微服务版本前端(使用vue-admin模板)。
...
~~~
top.easyvideo     
├── easyvideo_video_portal    // 前端门户网站 [80]
├── easyvideo_video_ui        // 前端 (后端管理) [81]
├── easyvideo-gateway         // 网关模块 [9728]
├── easyvideo-api             // 接口模块
│       └── api_pay                                      // 支付宝支付接口
│       └── api_user                                     // 用户接口
│       └── api_video                                    // 作品接口
...
├── easyvideo-common          // 通用模块
│       └── common_utils                                 // 工具类模块
│       └── service_base                                 // 业务配置模块
│       └── service_security                             // 认证模块
├── easyvideo_service         // 业务模块
